...
3.device_quchong_start_app_w2c.py	根据device打开app的时间对app进行排序，形成app_list, 对app_list进行去重操作, 将app开作词，device_id看成文档，对app进行embedding
4.device_age_prob_oof.py	单独对用户年龄进行预测
5.device_sex_prob_oof.py	单独对用户性别进行预测
6.start_close_age_prob_oof.py	对app所属的年龄概率进行预测
7.start_close_sex_prob_oof.py	对app所属的性别概率进行预测
...
因为本次比赛提交代码的时间比较仓促，之前一直都是用notebook来做比赛，所以如有问题，请联系团队
